...
async def generate_single_seg(idx, text, orig_dur):
    ...
    print(f"Seg {idx:02d} | Slot: {orig_dur:5.2f}s | Raw: {raw_dur:5.2f}s -> Final: {final_dur:5.2f}s (Speed {speed_factor:.2f}x)")
...
async def main():
    ...
    print("================================================================================")
    print("=== RENDERING ALL 23 SEGMENTS AUDIO FOR TẬP 6 ===")
    print("================================================================================\n")
    ...
    for idx, seg in enumerate(segments, 1):
        ...
        final_dur, speed_factor = await generate_single_seg(idx, new_text, orig_dur)
    ...
    conn.commit()
    print("\n🎉 All 23 segments audio rendered and saved to SQLite!")
