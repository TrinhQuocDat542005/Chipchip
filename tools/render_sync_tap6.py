...
async def render_all_sync():
    ...
    for idx, seg in enumerate(segments, 1):
        ...
        # Overwrite all potential filename variations so everything syncs
        ...
        print(f"Seg {idx:02d} OK | Slot: {orig_dur:5.2f}s | Audio: {final_dur:5.2f}s | Speed: {speed_factor:.2f}x")
